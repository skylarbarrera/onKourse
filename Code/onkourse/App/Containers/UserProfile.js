  ...
  render () {
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <Image source = {require('../Images/skylar.jpg')} style={{borderRadius: 75, width: 150, height: 150, marginTop: 30}} />


          <Text style = {{color: '#FFFFFF', fontSize: 20, paddingTop: 5}}>
            Computr{this.state.user.name}
          </Text>
          ...
          <View style={{flexDirection: 'row', alignItems: 'center', paddingTop: 10}}>
            ...
            <View style = {{ borderRightWidth: 1, borderColor: '#FFFFFF', paddingRight: 20, paddingLeft: 20}}>
              ...
              <Text style = {{ color: '#FFFFFF', fontSize: 16, fontWeight: 'bold'}}> 21</Text>
            </View>

            <View style = {{  borderColor: '#FFFFFF', paddingLeft: 20, alignItems: 'center'}}>
              <Icon name="check-circle" size={30} color="#FFFFFF" />
              <Text style = {{ color: '#FFFFFF', fontSize: 16, fontWeight: 'bold'}}> 32</Text>
            </View>
        ...
        <View style = {{flex: 3}}>
          <View style ={{ borderColor: "#000000", width: '90%', paddingBottom: 2, paddingTop: 10, alignSelf: 'center'}}>
            <Text style = {{fontSize: 20, fontWeight: 'bold'}}> Your Semester</Text>
          </View>
          <ScrollView>
          <View style = {{ flex:1}}>
            ...
            <View style = {{ flex:1}}>
              <TouchableOpacity onPress = {()=> this.props.navigation.navigate('ClassScreen', {classID: key, classInfo: this.state.results[key]})} style ={{borderBottomWidth: 1, borderColor: "#000000", width: '90%', height: 40, alignSelf: "center"}}>
                <Text style = {{fontSize: 16, fontWeight: 'bold'}} >Finite Automata </Text>

                <View style = {{flexDirection: 'row', alignItems: 'space-between'}}>
                  <View style ={{flexDirection: 'row'}}>

                    <TouchableOpacity onPress = {() => Linking.openURL('https://www.ratemyprofessors.com/ShowRatings.jsp?tid=911570')}>
                      <Text style = {{fontSize: 12} }>Weizen Mao |  </Text>
                    </TouchableOpacity>
              ...
              <View style = {{ flex:1}}>
                <TouchableOpacity onPress = {()=> this.props.navigation.navigate('ClassScreen', {classID: key, classInfo: this.state.results[key]})} style ={{borderBottomWidth: 1, borderColor: "#000000", width: '90%', height: 40, alignSelf: "center"}}>
                  <Text style = {{fontSize: 16, fontWeight: 'bold'}} >Managing Change & Org Transformation </Text>

                  <View style = {{flexDirection: 'row', alignItems: 'space-between'}}>
                    <View style ={{flexDirection: 'row'}}>

                      <TouchableOpacity onPress = {() => Linking.openURL('https://www.ratemyprofessors.com/ShowRatings.jsp?tid=911570')}>
                        <Text style = {{fontSize: 12} }>Ronald Sims |  </Text>
                      </TouchableOpacity>
                ...
                <View style = {{ flex:1}}>
                  <TouchableOpacity onPress = {()=> this.props.navigation.navigate('ClassScreen', {classID: key, classInfo: this.state.results[key]})} style ={{borderBottomWidth: 1, borderColor: "#000000", width: '90%', height: 40, alignSelf: "center"}}>
                    <Text style = {{fontSize: 16, fontWeight: 'bold'}} >Organizational Behavior </Text>
